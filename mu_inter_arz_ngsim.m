...
for t=para.Nt:-1:1
    for i = 1 : para.Nx-1
            ...
            mu_U_t=-u_(i,t)*(mu_U_x) ...
               -1/(para.uf^2)*(para.uf*(tra.we(i,t)/para.uf-tra.rhoe(i,t)/para.rhoj))^2; %cost 1
            ...
            mu_U_u_t=-u_(i,t)*(mu_U_u_x) ...
               +1/(para.uf^2)*(para.uf*(tra.we(i,t)/para.uf-tra.rhoe(i,t)/para.rhoj))*u_(i,t);
