...
u = tr.u;
q = rho.*u;
scatter(rho(:,2:end), q(:,2:end), MARKER_SIZE, 'k', 'filled');  

tr.w = min( tr.u + tr.rho.^para.gamma, 1);
%writematrix(tr.rho, "zm_bellshape_homoarz_rho.csv")
%writematrix(tr.u, "zm_bellshape_homoarz_GSOM_u.csv")
